...
홀수 QUERY
- 5번 (Type2) : 병원 입력 시 해당 병원의 부서 및 의사 정보 조회
- 7번 (Type3) : 부서별(부서이름 기준) 의사 수 조회
- 13번 (Type7): 의사 진료정보 상태 입력시 의사 정보+상태 조회
- 17번 (Type9) : 레코드가 많은 수대로 조회 , 없으면 출력하지 않음
- 19번 (Type10) : 부서 입력시 환자 수가 6명 이상인 병원 이름 조회
